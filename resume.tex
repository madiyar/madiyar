 ...
 & GitHub: \href{https://github.com/madiyar}{madiyar} \\ 
  ...
  \section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
          {Bank CenterCredit}{Almaty, KZ}
          {Frontend Developer}{Jan. 2026 - Present}
          \resumeItemListStart
            
    \projectName{AI Studio}
    \resumeItem{Stack}{React, TypeScript, Zustand, React-Query, Turborepo, TailwindCSS}
    \listItem{Working on AI Studio — an LLM-based platform for chat, agents, and workflows.} 
        ...
        \resumeSubheading
          {Jmart}{Almaty, KZ}
          {Frontend Developer}{Aug. 2022 - Sep. 2025}
          \resumeItemListStart
...
\listItem{Added code-splitting to reduce bundle size and improve load time. Added virtualization to the product list with infinite scrolling to ensure smooth page performance.} 
...
\listItem{Started project development from scratch.} 
        ...
        \resumeSubheading
          {DAR.tech}{Almaty, KZ}
          {Software Engineer}{Jan. 2020 - May. 2021}
          \resumeItemListStart
...
\listItem{Wrote unit tests using Jest and React Testing Library.} 
    ...
    \resumeSubHeadingListStart
        ...
        \item{
          \textbf{Technologies}{: React, Next.js, Redux (Toolkit, Saga), Tanstack Query, RTK Query, Tailwind CSS, styled-components, emotion, Material UI, Chakra UI, Ant design, Jest, Testing Library, Vite}
        }
